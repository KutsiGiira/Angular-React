  ...
  return (
    <footer className="w-full bg-[#101820] py-16 ">
      <div className="w-full max-w-[1920px] mx-auto px-8 md:px-16 ">
        <div className="grid grid-cols-1 md:grid-cols-4 ml-20">
          {/* Logo section */}
          <div className="flex flex-col space-y-4">
            <div className="flex items-center gap-3 ml-20" id="logo">
            ...
            <div className="font-normal text-white text-xs tracking-[0] leading-5 mt-16 ml-20" id="cR">
          ...
          <div className="grid grid-cols-2 md:flex md:flex-row gap-40">
