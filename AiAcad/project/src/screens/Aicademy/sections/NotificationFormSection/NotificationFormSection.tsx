...
export const NotificationFormSection = (): JSX.Element => {
  ...
  return (
    <section className="relative w-full flex justify-center items-center py-16 overflow-visible bg-gradient-to-b from-white via-white to-white">
      ...
      {/* Blur Circles */}
      <div className="absolute left-[-150px] top-[170px] md:w-[400px] md:h-[300px] w-[120px] h-[900px] bg-[#46B8FF] rounded-full blur-[150px] opacity-40 z-0" />
      <div className="absolute right-[-150px] top-[170px] md:w-[400px] md:h-[300px] w-[120px] h-[900px] bg-[#46B8FF] rounded-full blur-[150px] opacity-40 z-0" />
