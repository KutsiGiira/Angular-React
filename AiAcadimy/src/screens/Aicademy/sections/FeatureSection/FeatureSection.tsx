...
export const FeatureSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-6 px-4 py-12 w-full max-w-[900px] mx-auto">
      {/* Decorative icon */}
      ...
      {/* Section title */}
      <h2 className="font-['Poppins',Helvetica] font-medium text-[#18191b] text-4xl text-center tracking-[0] leading-10">
        What is Aicademy?
      </h2>

      {/* Section description */}
      <p className="font-['Poppins',Helvetica] font-normal text-neutral-700 text-lg text-center tracking-[0] leading-7 max-w-[800px]">
